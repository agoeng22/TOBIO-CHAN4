...
const { jasahapusakun } = require('./src/jasahapusakun')
...
const { hackingmenu } = require('./src/hackingmenu')
...
const samih = JSON.parse(fs.readFileSync('./arifirazzaq/simi.json'))
const user = JSON.parse(fs.readFileSync('./src/user.json'))
ban = []
cr = '*TOBIO-CHAN*'
vz = '*Terima Kasih Sudah Daftar Di TOBIO-CHAN*'
const vcard = 'BEGIN:VCARD\n' //
            + 'VERSION:3.0\n' //
            + 'FN: AGUNG\n' //
            + 'ORG:Creator TOBIO-CHAN;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=6282181347492:+6282181347492 \n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
limitawal = 99999
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Jangan Lupa Follow Instagram _agoeng_2'))
	})
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: 'Maaf Kak Fitur Ini Untuk User Mods TOBIO-CHAN',
					...
					userB: `「 *DAFTAR* 」\n\nMaaf Kak, Kakak Belum Terdaftar Sebagai Teman *TOBIo-CHAN*\nSilahkan Daftar Terlebih Dahulu , Agar Bisa Menggunakan *TOBIO-CHAN*\n\nCara Daftar : *${prefix}daftar Tobio|16*\n\nKalau Sudah Daftar , Jangan Lupa Ketik *${prefix}rules* untuk menampilkan menu bot\n\n「 *TOBIO-CHAN* 」`,
			...
			const ownerNumber = ["6282181347492@s.whatsapp.net","6282181347492@s.whatsapp.net","6289516155504@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const mod = [ownerNumber,"6282181347492@s.whatsapp.net","6282181347492@s.whatsapp.net","6289516155504@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const adminbotnumber = ["6282181347492@s.whatsapp.net","6282181347492@s.whatsapp.net","6289516155504@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const frendsowner = ["6282181347492@s.whatsapp.net","6282181347492@s.whatsapp.net","6289516155504@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const premium = ["6282181347492@s.whatsapp.net","6282181347492@s.whatsapp.net","6282163780008@s.whatsapp.net","6281977749250@s.whatsapp.net","6281315995628@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
...
├ ⧿⨵ */murrotal [surah]*
├ ⧿⨵ */sholawat [judul]*
├ ⧿⨵ */videodakwah [hukum memakai cadar]*
└ ⧿⨵ */listsurah*
...
*Jangan Lupa Untuk Donasi Agar Bot Selalu Aktif*
 https://saweria.co/agung22`})
                break
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*TOBIO-CHANgrup*\n\nLink : https://chat.whatsapp.com/ ', text, { quoted: mek })
					break
					case 'funmenu':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					...
					case 'nobg':
                                        ...
                                        anu1 = await fetchJson(`https://api.vhtear.com/removebgwithurl?link=${teks}&apikey=alpinbotwa`, {method: 'get'})
        ...
        case 'katadilan':
				...
				katadilan = `*${anu.result}*`
				client.sendMessage(from, katadilan, text, {quoted: mek})
				await limitAdd(sender) 
				break
					case 'addfoto':
					if (isBanned) return reply(mess.only.benned)    
       ...
       if (!isUser) return reply(mess.only.userB)
                ...
                if (isBanned) return reply(mess.only.benned)
					...
					case 'mining':
                      ...
                      if (!isEventon) return reply(`maaf ${pushname} event mining tidak di aktifkan sama owner Tobio`)
                      if (isOwner) {
                      const one = 999999999
                      addLevelingXp(sender, one)
                      addLevelingLevel(sender, 99)
                      reply(`karena Tobio baik Bot memberikan ${one}Xp >_<`)
                      }else{
...
case 'transfer':
                ...
                addKoinUser('6282181347492@s.whatsapp.net', fee)
				...
				if (!isPublic) return reply(mess.only.publikG)
				reply(mess.wait)
				 data = fs.readFileSync('./arifirazzaq/asupan.js');
				...
				break
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN TOBIO-CHAN ✨* 」\n*│+wa.me/6282181347492*╰──────*「 *TOBIO* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  TOBIO-CHAN_*\n*_Ketik /owner_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
            ...
            break
				   ...
				   if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=alpinbotwa`, {method: 'get'})
					reply(mess.wait)
                 ...
                 client.sendMessage(from, sendvir(prefix) , text, { quoted: mek })
                    ...
                    if (isBanned) return reply(mess.only.benned)    
                    if (!isUser) return reply(mess.only.userB)
                    client.sendMessage(from, jasahapusakun(prefix), text, { quoted: mek })
                    tod = await getBuffer(`https://i.ibb.co/Z11GvP8/jasahapusakun-profesional-20210222-094641.jpg`)
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Mengapa upload foto diri termasuk dosa JARIYAH? Karena.. Allah melarang wanita menampakkan kecantikannya kecuali pada Suami dan mahramnya.*'})
                    break
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Jangan lupa follow Instagram Owner Aku🙈 : @_agoeng_2*'})
                    break
                    case 'darkfb':
                    if (isBanned) return reply(mess.only.benned)    
                    if (!isUser) return reply(mess.only.userB)
 ...
 if (!isOwner) return reply(mess.only.ownerB)
   ...
   if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufasfer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=alpinbotwa`, {method: 'get'})
            ...
            break
                ...
                case 'pornlogo':
                  if (isBanned) return reply(mess.only.benned)    
					...
					buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${gbl1}&text2=${gbl2}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teks = body.slice(6)
					reply(mess.wait)
					loog = await getBuffer(`https://api.vhtear.com/gamelogo?text=${teks}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=arifi&pasangan=arifi&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl16}&bln=${gbl26}&thn=${gbl36}&apikey=alpinbotwa`, {method: 'get'})
					reply(anu.result.hasil)
					break
					case 'bass':                 
       if (!isUser) return reply(mess.only.userB)
                ...
                tahta = `${body.slice(7)}`
                     if (args.length < 1) return reply('Teksnya mana gan??')
                     if (args.length > 10) return reply('karakter minimal 10')
                     buff = await getBuffer(`https://api.vhtear.com/hartatahta?text=${tahta}&apikey=alpinbotwa`, {method: 'get'})
                  ...
                  case 'unafk':
					...
					reply(mess.wait)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pinte}&apikey=alpinbotwa`, {method: 'get'})
					reply(mess.wait)
			    ...
			    ja = jarak.split("/")[0];
			    rak = jarak.split("/")[1];
			    anu = await fetchJson(`https://api.vhtear.com/distance?from=${ja}&to=${rak}&apikey=alpinbotwa`, {method: 'get'})
				...
				case 'testing':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/watercolour?text1=${gbl38}&text2=${gbl48}&apikey=apivinz`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      naon = body.slice(9)
                      reply(mess.wait)
                      anu = await fetchJson(`https://arugaz.my.id/api/textpro/neonlight?text=${naon}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/snowwrite?text1=${gbl7w}&text2=${gbl8w}&apikey=apivinz`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/metal_maker?text=${love}&apikey=alpinbotwa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'apiteks':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/fire_maker?text=${love}&apikey=alpinbotwa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'ffbaner':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/bannerff?title=${love}&text=ARIFI%20RAZZAQ&apikey=alpinbotwa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
					case 'goldbutton':
					if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=metal_dark_gold&text=${tels}&apiKey=alpinbotwa`, {method: 'get'})
				...
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=blue_metal&text=${tels}&apiKey=alpinbotwa`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'textsky':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=sky_online&text=${tels}&apiKey=alpinbotwa`, {method: 'get'})
          ...
          if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferw = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      gl1 = gdh.split("|")[0];
                      gl2 = gdh.split("|")[1];
                      buffere = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=alpinbotwa`, {method: 'get'})
                      reply(mess.wait)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/logoml?hero=miya&text=${part}&apikey=alpinbotwa`, {method: 'get'})
					client.sendMessage(from, bufferu, image, {caption: 'Nih kak', quoted: mek})
					break
				case 'shadow':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					tigaa1 = await getBuffer(`https://api.vhtear.com/blackpinkicon?text={dimen1}&apikey=alpinbotwa`)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferi = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=alpinbotwa`, {method: 'get'})
	...
	if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					hobby = body.slice(1)
					const hob =['Mengocok Pacar','Membantu Atok','Mabar','Nobar','Sosmedtan','Membantu Orang lain','Nonton Anime','Nonton Drakor','Naik Motor','Nyanyi','Menari','Bertumbuk','Menggambar','Foto fotoan Ga jelas','Maen Game','Berbicara Sendiri']
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					const bisa =['Bisa','Tidak Bisa','KAGAK NGERTI','MANA GW TAU']
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
					kapankah = body.slice(1)
					const toxic =['anjing','babi lu','Kasian sperma mu dek','udah tolol nub Lagi','muka lo kek monyet','udah jomblo sendirian lagi dirumah tolol','so so an mau punya pacar muka aja kek monyet lepass dari kandang','ganteng doang di toxic aja dibilang baperan','pantek kau','bangsat kau','ku entod kalian nangis kau','memek lu semua','lihat anak anjing lagi baca','ganteng doang jemput cewe dipanggang','kamu cantik beb bullshit anjing cowo buaya','anak dajjal','puki lu','anjing ngajak gelud','sama hantu takut cupu ngentod','cupu cupu aja gausah bacot','kontol lu semua','bocah lu semua kontol','3 Hari Lagi']
				...
				if (!isPublic) return reply(mess.only.publikG)     
					...
					tod = await getBuffer(`https://i.ibb.co/GPZMm2w/20210213-075326.jpg`)
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*dana :* _0821-8134-7492_\n*gopay :* _0821-8134-7492_', text, { quoted: mek })
					break
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('6282181347492@s.whatsapp.net', options, text, {quoted: mek})
			    ...
			    if (isLimit(sender)) return reply(limits.limitend(pushname2))
			    reply(mess.wait)
                    anu = await fetchJson(`https://api.vhtear.com/infoalamat?query=${body.slice(12)}&apikey=alpinbotwa`, {method: 'get'})
			        client.sendMessage(from, `${anu.result.data}`, text, {quoted: mek})
			        await limitAdd(sender) 
			        break
                    case 'request':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teksj = body.slice(7)
					reply(mess.wait)
					anwu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teksj}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://api.vhtear.com/randomloli&apikey=alpinbotwa`, {method: 'get'})
...
reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=alpinbotwa`, {method: 'get'})
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=alpinbotwa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/nhentaipdfdownload?query=287167&apikey=alpinbotwa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					reply(mess.wait)
						...
						client.sendMessage(from, buffercc, image, {quoted: mek, caption: 'Jangan jadiin bahan buat coli om'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				...
				if (!isUser) return reply(mess.only.userB)
					...
					reply(mess.wait)
						...
						client.sendMessage(from, buffervv, image, {quoted: mek, caption: 'Jangan jadiin bahan buat coli om'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
		...
		anu = await fetchJson(`https://api.vhtear.com/ytdl?link=${args[0]}&apikey=alpinbotwa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
		...
		if (args.length < 1) return reply('tag temanmu!')
			    ...
			    reply(mess.wait)
              	    if (args.length < 1) return reply('teksnya mana gan?')
                    teks = body.slice(5)
                    anu = await fetchJson(`https://api.vhtear.com/xxxsearch?query=${teks}&apikey=alpinbotwa`, {method: 'get'})
                    teks = `===============\n`
                    {
                ...
                if (isBanned) return reply(mess.only.benned)    
				    ...
				    if (!isPublic) return reply(mess.only.publikG)
				    reply(mess.wait)
                   anu = await fetchJson(`https://api.vhtear.com/cerita_sex&apikey=alpinbotwa`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
				reply(mess.wait)
				 data = fs.readFileSync('./arifirazzaq/drak.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
          ...
          reply('Wait..')
				...
				reply(mess.wait)
				anu = await fetchJson(`https://api.vhtear.com/downloadfilm?judul=${body.slice(6)}&apikey=alpinbotwa`, {method: 'get'})
				if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=alpinbotwa`, {method: 'get'})
					reply(anu.result.hasil)
					break
				case 'textscreen':
				if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					telsjk = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${telsjk}&apikey=alpinbotwa`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (data.error) return reply(data.error)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isGroup) return reply(mess.only.group)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewanimutlucu&apikey=alpinbotwa`, {method: 'get'})
              ...
              case 'infogempa':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                   teks = body.slice(5)
                   anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/githubprofile?user=${teks}&apikey=alpinbotwa)`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				case 'hackertext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=theme=matrix=${tels}&apiKey=alpinbotwa`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
     case 'infocuaca':
...
if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=alpinbotwa`, {method: 'get'})
					setTimeout( () => {
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=alpinbotwa`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=alpinbotwa`, {method: 'get'})
 ...
 if (!isPublic) return reply(mess.only.publikG)
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://tobz-api.herokuapp.com/api/hug?apikey=alpinbotwa', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
 ...
 if (isBanned) return reply(mess.only.benned)    
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumitokisakikawai&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=remrezero&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ramrezero&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			   ...
			   reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
		            ...
		            if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cewekcantik&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cowokganteng&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewan&apikey=alpinbotwa`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=lolikawai&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=waifukawai&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=nekoanimekawai&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isNsfw) return reply('❌ *FALSE* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=alpinbotwa`, {method: 'get'})
                ...
                if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=alpinbotwa`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
					pine = await getBuffer(trest)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=bokep&apikey=alpinbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPremium) return reply(mess.only.premium)
				 data = fs.readFileSync('./arifirazzaq/18.js');
		...
		;			client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					anu = await fetchJson(`https://https://api.vhtear.com/youtube?query=$ytsearch1}&apikey=alpinbotwa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
				...
				if (isBanned) return reply(mess.only.benned)    
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/tiktokdl?link=${args[0]}&apikey=alpinbotwa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks}&apikey=alpinbotwa`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case '8bit':
                                          if (isBanned) return reply(mess.only.benned)    
                    ...
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=bit8&text=${teks}&text=${teks}&apikey=BotWeA`, {method: 'get'})
			     	...
			     	break
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=alpinbotwa`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
				case 'tiktokstalk':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=alpinbotwa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'airtext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/water_maker?text=${teks}&apikey=alpinbotwa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'kuncitext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/padlock?text1=${teks}&text2=${teks}&apikey=alpinbotwa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
			if (!isPublic) return reply(mess.only.publikG)
                    anu = await fetchJson(`https://tobz-api.herokuapp.com/api/shorturl?url=${body.slice(10)}&apikey=alpinbotwa`)
			        hasil = `${anu.result}`
			        reply(hasil)
			        break
			    case 'infonotlp':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=alpinbotwa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=alpinbotwa`, {method: 'get'})
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/logoff?hero=alok&text=${tels}&apikey=alpinbotwa`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					 client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'tstiker':
			...
			if (!isPublic) return reply(mess.only.publikG)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  *TOBIO-CHAN* 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *TOBIO Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (Number(args[0]) === 1) {
						...
						samih.push(from)
						fs.writeFileSync('./arifirazzaq/simi.json', JSON.stringify(samih))
	...
	.then(() => {client.sendMessage(from, options, text)})
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner TOBIO-CHAN!', id)
                   for (let i = 0; i < mentionedJidList.length; i++) {
                   adminNumber.push(mentionedJidList[i])
                   fs.writeFileSync('./lib/database/admin.json', JSON.stringify(adminNumber))
                   reply('Success Menambahkan Admin TOBIO-CHAN!')
				   }
                   break
